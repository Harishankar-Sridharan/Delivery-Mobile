...
The Mobile Dashboard provides real-time visibility into route information, including the route date, number of missions, total planned distance (km), total driving time, and the current route status (such as Early, On Time, or Late). This enables users to monitor route progress and operational performance at a glance.
